...
<!DOCTYPE html>
    ...
    <body style="background-color: rgb(48, 48, 48);">
        ...
        <div class="w3-top">
            ...
            <a href="HomePage.php" class="w3-bar-item w3-button w3-hide-small w3-hover-white"><i class="fa fa-home w3-margin-right"></i>IIITN Question Bank</a>
...
{
                $dbLink = new mysqli('localhost', 'root', '', 'iiitnq');
