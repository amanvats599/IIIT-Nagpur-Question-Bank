...
<body>
<div style="background-color:black;  " class="topnav" >
  <a style="padding- left: 100px;" class="active" href="HomePage.php">Home</a>
</div>
  <br>
  <br>
      <div class="cont">
          <div class="form sign-in">
              <div class="d-flex flex-row">
                <img src="https://iiitn.ac.in/images/main-logo-90x90.png" class="nitc-logo"/>
                <h2 style="font-weight:700;" class="pt-3">Login to IIITN Question Bank</h2>
              </div>
                   <div class="login m-5">
                    ...
                    <div class="form sign-up">
                        ...
                        <div class="form2" >
                            <form action ="reg.php" method="POST" id="form">
                                <label>
                                    <span style="color: rgb(71, 71, 71);">Roll Number</span>
                                    <input type="text" name="Roll_no" id="roll_number" required/>
