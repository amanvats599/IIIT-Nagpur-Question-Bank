...
<html>
  <head>
    <title>IIITN Question Bank</title>
    <meta charset="UTF-8">
...
<div class="w3-top">
 <div class="w3-bar w3-theme-l1 w3-left-align">
      ...
      <a href="#" class="w3-bar-item w3-button w3-teal"><i class="fa fa-home w3-margin-right"></i>IIITN Question Bank</a>
      <a href="index.php" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Login</a>
  ...
  <div class="row">
    <div class="col-7">
      <div class="w3-container w3-padding-64 w3-center responsive"">
        <h2 class="homepage-heading">IIITN Question Bank</h2>
        <p class="homepage-para">From Normal book to a digitalised question bank, </br> 
          we provide an all-in-one space of information for the IIITN students to access all the 
    ...
    <div class="w3-col m6 d-flex flex-row justify-content-center mt-5">
      ...
      <div>
        <form action="Download.php" method="POST">
          <button type="submit" class="w3-button w3-center home-button" name="Submit" id="Submit"> See Paper</button>
        </form>
      </div>
    </div>
  </div>
...
<footer class="w3-container w3-padding-32 w3-theme-d1 w3-center">
  ...
  <p><i class="fa fa-map-marker w3-text-teal w3-xlarge"></i>  IIIT Nagpur, Maharastra.</p>
  <p><i class="fa fa-phone w3-text-teal w3-xlarge"></i> 1234567890</p>
  <p><i class="fa fa-envelope-o w3-text-teal w3-xlarge"></i>  iiitn_questions@gmail.com</p>
</footer>
